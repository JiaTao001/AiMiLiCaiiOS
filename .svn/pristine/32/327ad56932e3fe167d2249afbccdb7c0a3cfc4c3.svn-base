...
- (UIImageView *)IV{
    if (!_IV ) {
        _IV = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"head_text_3"]];
...
{    
    ...
    NSDate *lastUpdatedTime = [USERDEFAULTS objectForKey:lastUpdatedTimeKey];
...
//    if (self.lastUpdatedTimeLabel.hidden) {
    ...
    self.IV.frame = CGRectMake(self.bounds.size.width/2 - 50, self.bounds.size.height/2+5, 100, 13);
//    } else {
//        // 状态
