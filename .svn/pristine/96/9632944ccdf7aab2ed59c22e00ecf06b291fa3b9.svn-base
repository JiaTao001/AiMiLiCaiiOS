...
- (UIView *)dismissKeyboard {
    ...
    if (!_dismissKeyboard) {
        ...
        NSArray *hConstraint = [NSLayoutConstraint constraintsWithVisualFormat:@"H:[accessoryAction]-(distance)-|" options:0 metrics:@{@"distance":@(BIG_MARGIN_DISTANCE)} views:NSDictionaryOfVariableBindings(accessoryAction)];
